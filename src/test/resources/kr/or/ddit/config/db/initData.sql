...
Insert into USERS (USERID,USERNM,PASS,REG_DT,ALIAS,ADDR1,ADDR2,ZIPCODE,FILENAME,REALFILENAME) values 
('ddit','대덕인재','dditpass',to_date('2021/02/02','YYYY/MM/DD'),
'개발원_m','대전시 중구 중앙로 76','4층 대덕인재개발원','34940',null,null);			
