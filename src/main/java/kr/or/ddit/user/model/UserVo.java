...
public class UserVo {
	...
	// 대다수의 framework는 기본 생ㅇ성자를 필요로 한다.
	 ...
	 * 
	 * // reg_dt 필드가 null이면 "" 문자열 반환 // reg_dt 필드가 null이 아니면 SimpleDateFormat을 //
	 * 생성하여 yyyy.MM.dd 포맷의 문자열로 변홚여 리턴
	 * 
	 * if(this.reg_dt == null) { return ""; } else { SimpleDateFormat sdf = new
	 * SimpleDateFormat("yyyy.MM.dd"); return sdf.format(this.reg_dt); //return new
	 * SimpleDateFormat("yyyy.MM.dd").format(this.reg_dt); }
	 * 
	 * }
	 */
	/*
	 * public String getReg_dt() { return reg_dt; } public void setReg_dt(String
	 * reg_dt) { this.reg_dt = reg_dt; }
	 */	
